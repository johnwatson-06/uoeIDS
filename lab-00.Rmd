...
```{r setup-tibble}
team_data <- tibble(
  name = c("John", "Lena", "Ellie", 
          "Elaine", "Caitlyn","Karis"),
  github_username = c("cb0wman2",  "karis-mcfarlane", "lenaartus", "elliehuntt", 
                       "johnwatson-06", "elaine-cyl"), 
...
p1 + labs(x = "github_username", 
          y = "favourite_number",
          title = "Favourite Numbers and Colours")
```
